                  ...
                  //console.log(element);                                
                    if(options.validate === '--validate'){                        
                      fetch(element.href).then((response) => {
                        console.log('Archivo: '+ pathFileAbs.blue,'linea: '+ element.line, 'Link: '+ element.href.green, 'Estado: ' + response.status, response.statusText.red);      
                        }).catch((error) => {
                          console.error("Error: no encontro links" + error);
                      });                       
                  }else{
                    console.log('Archivo: '+ pathFileAbs.blue, 'Linea: '+ element.line, 'Link: '+ element.href.green);              
                  }
                });                     
                /*
